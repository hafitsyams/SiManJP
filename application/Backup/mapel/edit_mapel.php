                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="" method="post">
                        <div class="form-group <?=form_error('idnya') ? 'has-error': null?>">
                            ...
                            <input type="text" name="idnya" value="<?=$this->input->post('idnya') ?? $row->idmapel?>" class="form-control">
                            <?php echo form_error('idnya')?>
                        </div>
                        <div class="form-group <?=form_error('namamapel') ? 'has-error': null?>">
                            <label> Nama Mata Pelajaran</label>
                            <input type="text" name="namamapel" value="<?=$this->input->post('namamapel') ?? $row->namamapel?>" class="form-control">
